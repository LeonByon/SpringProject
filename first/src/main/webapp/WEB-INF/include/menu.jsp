...
<ul>
	...
	<li>|</li>
	<li class="topMenuLi"><a class="menuLink" href="${path}/shop/cv_list.do">편의점</a></li>
	<li>|</li>
	...
	<li>|</li>
	<li class="topMenuLi"><a class="menuLink" href="${path}/board/board_list.do">게시판</a>
	<ul class="subMenu">
			<li><a class="subMenuLink" href="${path}/sample/openBoardList.do">정보공유</a></li>
	</ul>
	</li>
	<li>|</li>
